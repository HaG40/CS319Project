        ...
        <>
            <div className="z-1 fixed bg-emerald-400 flex flex-row justify-between w-screen h-16 shadow">
                ...
                <div className="flex flex-row justify-end items-center gap-2 mx-5 text-white text-lg p-4 cursor-pointer">
                    ...
                    {isAuthenticated && user?.username !== "admin" && <Link to="/user" className="hover:text-emerald-400 hover:underline rounded-full p-3 text-xl shadow bg-emerald-600 hover:bg-amber-50"><FaUser/></Link>}
                    {user?.role === "admin" && user.username === "admin" && <Link to="/user/manager" className="hover:text-emerald-400 hover:underline rounded-full p-3 text-xl shadow bg-emerald-600 hover:bg-amber-50"><FaUsersCog/></Link>}
                    ...
                    <Link to="/about" className="hover:text-emerald-400 hover:underline rounded-full p-3 text-xl shadow bg-emerald-600 hover:bg-amber-50"><FaCoffee/></Link>
